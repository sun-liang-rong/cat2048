...
} from '../assets/scripts/economy/economy';
import { allCosmetics, DEFAULT_ECONOMY, SHOP_ITEMS } from '../assets/scripts/economy/catalog';
import { DEFAULT_SAVE, SAVE_KEY } from '../assets/scripts/infrastructure/storage';
